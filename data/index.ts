...
export interface IFacilitity {
  image_url: string;
  facility: string;
}

export const facilities: IFacilitity[] = [
  {
    image_url: '/icons/community.svg',
    facility: 'Community Events'
  },
  {
    image_url: '/icons/gym.svg',
    facility: 'Gym Facilities'
  },
  {
    image_url: '/icons/wifi.svg',
    facility: 'High-Speed WiFi'
  },
  {
    image_url: '/icons/coffee.svg',
    facility: 'Cafe & Tea Bar'
  },
  {
    image_url: '/icons/price.svg',
    facility: 'Affordable'
  },
  {
    image_url: '/icons/chair.svg',
    facility: 'Comfort Lounges'
  },
  {
    image_url: '/icons/redo.svg',
    facility: 'Quick Booking'
  },
  {
    image_url: '/icons/tennis.svg',
